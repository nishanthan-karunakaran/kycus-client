...
export class ValidatorsService {
  ...
  emailValidator(customMessage?: string): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return valid ? null : { email: true, validationError: customMessage || 'Invalid email format' };
    };
  }
  ...
  aadhaarValidator(customMessage?: string): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return valid ? null : { aadhaar: true, validationError: customMessage || 'Invalid Aadhaar number' };
    };
  }
  ...
  mobileNumberValidator(customMessage?: string): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      return valid ? null : { mobileNumber: true, validationError: customMessage || 'Invalid mobile number' };
    };
  }
}
